    ...
    L.SVG.include({
        ...
        __fillPattern: function(layer) {
            ...
            if (!_p) {
                ...
                _p.setAttribute('width', '8');
                _p.setAttribute('height', '8');
                var _rect = L.SVG.create('rect');
                _rect.setAttribute('width', 8);
                _rect.setAttribute('height', 8);
                ...
                _img.setAttribute('width', '8');
                _img.setAttribute('height', '8');
                _p.appendChild(_img);
